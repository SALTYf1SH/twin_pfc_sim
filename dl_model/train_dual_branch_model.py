# -*- coding: utf-8 -*-
"""
Main script for training the DUAL-BRANCH surrogate model.

This script defines a two-branch model architecture:
1. A static branch (MLP) processes time-invariant rock parameters.
2. A dynamic branch (Transformer) processes time-variant surface subsidence data.
...
STATIC_FEATURES = 11 # Number of rock property features
...
def train_model(model, train_loader, val_loader, criterion, optimizer, device):
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if avg_val_loss < best_val_loss:
            ...
            model_path = os.path.join(OUTPUT_DIR, "best_dual_branch_model.pth")
...
def main():
    ...
    print("========================================================")
    print("      Dual-Branch Surrogate Model Training Script     ")
    print("========================================================")
    ...
    if not os.path.isdir(dataset_full_path):
        ...
        print("Please run data_extractor.py or process_new_data.py first.")
        return
