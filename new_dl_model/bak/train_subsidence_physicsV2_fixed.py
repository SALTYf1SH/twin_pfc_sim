...
def main():
    ...
    temp_dataset = SequentialSubsidenceDataset(all_files, PARAMS_JSON_PATH)
    ...
    train_ds = SequentialSubsidenceDataset(train_files, PARAMS_JSON_PATH, transform=transform)
    val_ds = SequentialSubsidenceDataset(val_files, PARAMS_JSON_PATH, transform=transform)
